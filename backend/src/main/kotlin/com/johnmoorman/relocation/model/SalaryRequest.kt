...
/**
 * Request body for POST /api/v1/salary/calculate. Mirrors the TypeScript interface in
 * shared/api-contracts/salary.ts.
 */
data class SalaryRequest(
        ...
        val grossAnnual: Int?,
        @field:NotNull(message = "Tax class is required") val taxClass: TaxClass?,
